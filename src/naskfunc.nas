...
; 需要与bootpack.obj链接，所以需要编译成目标文件
[FORMAT "WCOFF"]                 ; 制作目标文件的模式
[INSTRSET "i486p"]               ; 486模式，防止寄存器名被误解成标签或常数
...
;	下面调整栈，以免用RETF跳转到应用程序
		OR		ECX,3			; 将应用程序用段号和3机型OR运算
		OR		EBX,3			; 将应用程序用段号和3机型OR运算
		PUSH	EBX				; 应用程序的SS
		PUSH	EDX				; 应用程序的ESP
		PUSH	ECX				; 应用程序的CS
		PUSH	EAX				; 应用程序的EIP
